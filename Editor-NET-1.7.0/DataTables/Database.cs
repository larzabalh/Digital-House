...
namespace DataTables
{
    ...
    public class Database : IDisposable
    {
        ...
        /// <summary>
        /// Get debug information. Each query will add an extra item to the list, with
        /// the text of the query and information about any bound values.
        /// 
        /// Note that calling this method will empty the list, so any new queries
        /// will be added to an empty list.
        /// </summary>
        /// <returns>Query information list</returns>
        public List<DebugInfo> DebugInfo()
        {
            var debugInfo = _debugInfo;
            _debugInfo = new List<DebugInfo>();
